...
import static xemistry.common.XReference.*;
...
public class ConfigurationHandler {
    ...
    public static void init(File configFile) {
        ...
        try {
            ...
            Property greenStillId = configuration.getOrCreateBlockIdProperty("greenStill", XReference.greenWaterID);
            Property greenMovingId = configuration.getOrCreateBlockIdProperty("greenMoving", XReference.greenMovingID);
